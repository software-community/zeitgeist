...
def accomodation_payment_request(name,amount,purpose,email,mobile):
    ...
    response = api.payment_request_create(buyer_name=name,amount=amount,purpose=purpose,send_email=True,email=email,phone=mobile,redirect_url='http://zeitgeist.org.in/accomodation_payment_redirect',weebhook='http://zeitgeist.org.in/accomodation_weebhook')
    return response